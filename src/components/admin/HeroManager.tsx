...
export default function HeroManager() {
  ...
  const handleSave = async () => {
    if (!formData.media_url.trim()) {
      toast({ title: "Please upload or provide media URL", variant: "destructive" });
      return;
    }
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Duration: {slide.media_type === "video" ? "Until video ends" : `${slide.display_duration}s`}
                  </p>
                </div>
      ...
      <Dialog open={showDialog} onOpenChange={handleCloseDialog}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Add images or videos to your homepage hero carousel
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v: "image" | "video") =>
                  setFormData((prev) => ({ ...prev, media_type: v }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-2">
              ...
              <Input
                placeholder="Welcome to SPEAKAI"
            ...
            <div className="space-y-2">
              ...
              <Input
                placeholder="Master English with AI"
            ...
            {formData.media_type === "image" && (
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  onValueChange={([v]) =>
                    setFormData((prev) => ({ ...prev, display_duration: v }))
                  }
                  min={2}
                  max={15}
                  step={1}
                />
                <p className="text-xs text-muted-foreground">
                  How long this image shows before moving to the next slide
                </p>
              </div>
            )}
            ...
            {formData.media_type === "video" && (
              <p className="text-sm text-muted-foreground">
                Videos will play until they end, then move to the next slide
              </p>
            )}
